<template>
  <div class="h-full fontNoto bg-gray1 overflow-x-hidden">
    ...
    <div class="sm:hidden lg:inline md:inline">
        <div class=" bg-banner2 w-full bg-center bg-no-repeat bg-contain lg:-mt-32 lg:pt-2 md:-mt-60 md:pt-6">
              <div class="relative flex h-screen w-screen items-center justify-center container mx-auto px-8 ">
                  <div class="absolute inset-x-0 lg:bottom-60 md:bottom-72 text-center">
                      ...
                      <p class="text-3xl lg:text-lg md:text-lg whitespace-pre-line">ใครที่มีคำถามนี้ในใจเป็นประจำทุกวัน วันนี้ Foodrand มีเมนูอาหารมาแนะนำ</p>
                      <p class="text-3xl lg:text-lg md:text-lg whitespace-pre-line">ไม่ต้องคิดเองให้เสียเวลา ตามเรามาดูกันเลยว่ามีเมนูไหนให้เลือกบ้าง</p>
                  </div>
              </div>
        </div>
    </div>
