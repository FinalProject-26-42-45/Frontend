<template>
  <div class="fontNoto flex relative overflow-y-auto">
    <div class="fixed left-0 top-0 h-screen p-10 px-4 py-8 border-r bg-yellow">
      ...
      <div id="nav" class="flex flex-col flex-1 mt-10">
        <router-link to="/admin-manage" class="cursor-pointer  flex items-center px-4 py-3 mt-5 rounded-full bg-white text-black hover:bg-gray-200" exact>
            <font-awesome-icon icon="rectangle-list" class="block h-6 w-6 " />
            <span class="mx-4 font-medium">เมนูอาหาร</span>
        </router-link>
        <router-link to="/admin-user" class="cursor-pointer flex items-center px-4 py-3 mt-5 rounded-full bg-white text-black hover:bg-gray-200" exact>
                    ...
                    <table class="min-w-max w-full table-auto ">
                        <thead>
                            <tr class="bg-coral1 text-white uppercase text-lg leading-normal ">
                                <th class="py-3 px-6 text-left rounded-tl-lg">ชื่อ-นามสกุล</th>
                                <th class="py-3 px-6 text-left">ชื่อผู้ใช้งาน</th>
                                <th class="py-3 px-6 text-left rounded-tr-lg">ศาสนา</th>
                            </tr>
                        </thead>
                        <tbody v-for="u in users" :key="u.UserId" class="text-gray-600 font-light bg-white">
                             <tr class="border-b border-gray-200 hover:bg-gray-100">
                                ...
                                <td class="py-3 px-6 text-left">
                                    <div class="flex items-center">
                                        <span class="font-medium text-lg">{{ u.Religion }}</span>
                                    </div>
                                </td>
                            </tr>
                        </tbody>
